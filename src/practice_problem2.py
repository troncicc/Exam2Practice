...
def run_test_practice_problem2a():
    ...
    test1 = practice_problem2a([2, 10, 5, -20, 8], 6)
    print('Expected:', '[8, 16, 11, -14, 14]')
    print('Actual:  ', test1)

    test2 = practice_problem2a([5, 10, 15, 10, 5], 2)
    print('Expected:', '[7, 12, 17, 12, 7]')
    print('Actual:  ', test2)

    test3 = practice_problem2a([0, 0], -2)
    print('Expected:', '[-2, -2]')
    print('Actual:  ', test3)

    test4 = practice_problem2a([100, 200, 0, 5], 10)
    print('Expected:', '[110, 210, 10, 15]')
    print('Actual:  ', test4)
